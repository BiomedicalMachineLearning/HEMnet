...
OUTPUT_PATH = Path('/gpfs1/scratch/90days/s4436005/img_reg/train_dataset_10x_12_12_19')
...
for num in range[4]:
    ...
    #t_mask_tp53 = tissue_mask(tp53_filtered, tile_size, 0.1)
    tgen = tile_gen(he_filtered, tile_size)
    t_mask_he = threshold_mask(tgen, 250)
    #t_mask_he = tissue_mask(he_filtered, tile_size, 0.1)
    ...
    verbose_print('Generated Masks for: ' + PREFIX)
